...
//same as dalvik/vm/oo/Object.h ==> struct Method
...
typedef void* (*dvmFindSystemClass_func)(const char*);
typedef void* (*dvmFindSystemClassNoInit_func)(const char*);
typedef void* (*dvmFindClassNoInit_func)(const char*,void *);
...
struct dexstuff_t
{
	...
	dvmFindSystemClassNoInit_func dvmFindSystemClassNoInit_fnPtr;
